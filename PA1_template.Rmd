...
```
* The filled data mean is `r mean_filled`
* The filled data median is `r median_filled`
* The difference between the non-filled mean and filled mean is `r mean_diff`
* The difference between the non-filled mean and filled mean is `r med_diff`
* The difference between total number of steps between filled and non-filled data is `r total_diff`. Thus, there were `r total_diff` more steps in the filled data.
